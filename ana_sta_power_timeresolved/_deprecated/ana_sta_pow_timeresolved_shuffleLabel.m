function ana_sta_pow_timeresolved_shuffleLabel(list,datadir,figpath)
...
%                 dat2shf = tmpshf(:,ii+1:end,:); 
    ...
    %save
    sname = [figpath '/pow_slidewin_fft_ncycle' num2str(ncycle) '_' normstr '_multcomp' num2str(doMultComp) '_shuffledLabel'];
    save2pdf(sname,gcf)
    
    sname2 = [figpath '/pow_slidewin_datout_ncycle' num2str(ncycle) '_' normstr '_shuffledLabel.mat'];
